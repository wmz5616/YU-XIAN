...
<template>
  <div class="min-h-screen flex flex-col bg-slate-50 font-sans text-slate-800">
    ...
    <header
      class="sticky top-0 z-50 bg-white/70 backdrop-blur-xl border-b border-slate-200/50 shadow-sm transition-all duration-300 supports-[backdrop-filter]:bg-white/60">
